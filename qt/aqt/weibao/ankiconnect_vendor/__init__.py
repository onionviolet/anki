...
class AnkiConnect:
    ...
    def startWebServer(self):
        try:
            ...
            self.server.close()
            print('Bundled AnkiConnect could not listen on port {}: {}'.format(util.setting('webBindPort'), exc))
            return False
...
# The fork starts this vendored server explicitly after add-on loading.
# This avoids binding the same port as an installed AnkiConnect add-on.
